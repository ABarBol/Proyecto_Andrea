...
<div class="container">
    <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3">
      <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
        ...
        <p class="lead">Gestiona tus tareas diarias y proyectos grupales en un solo lugar. Nuestra aplicación te permite crear, compartir y seguir tus actividades con facilidad.</p>
        @guest
